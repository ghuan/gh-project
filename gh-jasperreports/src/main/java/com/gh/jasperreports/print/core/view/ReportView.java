package com.gh.jasperreports.print.core.view;

import com.msf.common.core.util.VTools;
import com.msf.print.core.DocType;
...
public class ReportView extends AbstractView {
	...
	public ReportView(JasperDesign jasperDesign,String docType,boolean inline,String fileName,String pxImageUrl) {
		...
		this.inline = inline;
		this.fileName = VTools.StringIsEmpty(fileName) ? jasperDesign.getName() : fileName;
	...
	protected void renderMergedOutputModel(Map<String, Object> map,
		...
		if(DocType.HTML.getTypeName().equals(docType)){
			...
			exporter.setParameter(JRHtmlExporterParameter.IMAGES_URI, (VTools.StringIsEmpty(this.pxImageUrl)
				?
